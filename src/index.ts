...
async function main() {
	...
	// gets repos that have package.json
	...
	// returns object with blob path: file name eg. /blah/package.json and dependencies in it
	...
	// get dependencies of a repo, return repoDep object
			...
			for (const ext of extensions) {
				...
				if (blobPath.endsWith(ext)) {
					...
					if (depCount > 0){
						...
						// console.log(blobPath)
						// console.log(dependencies)
						// console.log(JSON.stringify(repoDepObj.blobPathDepsList, null, " "));
					}
					else{
						// includes package.json files with no dependencies
