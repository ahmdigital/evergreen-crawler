...
test("Test dependency list JSON", async () => {
	...
	depNameMap.set("x", 1);
	depData.set(1, {version: "1.2.3", link: "www.x.com", lastUpdated: "", internal: true, archived: false})
	depNameMap.set("y", 2);
	depData.set(2, {version: "21.9.03", link: "www.y.com", lastUpdated: "", internal: true, archived: false})
	depNameMap.set("z", 3);
	depData.set(3, {version: "7.3.32", link: "www.z.com", lastUpdated: "", internal: false, archived: false})
	depNameMap.set("12", 4);
	depData.set(4, {version: "4.2.1", link: "www.12.com", lastUpdated: "", internal: true, archived: true})
	depNameMap.set("#&,", 5);
	depData.set(5, {version: "1.4.5", link: "www.%23%26%2C.com", lastUpdated: "", internal: true, archived: false})
	depNameMap.set("w", 6);
	depData.set(6, {version: "8.4.19", link: "www.w.com", lastUpdated: "", internal: false, archived: true})
	...
	const expected = {
		"1": { name: "x", version: "1.2.3", link: "www.x.com", lastUpdated: "", internal: true, archived: false},
		"2": { name: "y", version: "21.9.03", link: "www.y.com", lastUpdated: "", internal: true, archived: false},
		"3": { name: "z", version: "7.3.32", link: "www.z.com", lastUpdated: "", internal: false, archived: false},
		"4": { name: "12", version: "4.2.1", link: "www.12.com",  lastUpdated: "", internal: true, archived: true},
		"5": { name: "#&,", version: "1.4.5", link: "www.%23%26%2C.com", lastUpdated: "", internal: true, archived: false},
